...
class DatabaseHelper {
  ...
  static final columnExtras = 'extras';
  ...
  // inserted row.
  Future<int> insert(WishlistModel item) async {
  ...
  Future<int> update(WishlistModel item) async {
    Database db = await instance.database;
    String productName = item.toMap()['productName'];
    return await db.update(table, item.toMap(),
        where: '$columnName = ?', whereArgs: [productName]);
  }
